...
// Contract Addresses
export const NST_FINANCE_ADDRESS = process.env.NEXT_PUBLIC_NST_FINANCE_ADDRESS as Address;
...
export const NST_TOKEN_ADDRESS = process.env.NEXT_PUBLIC_NST_TOKEN_ADDRESS as Address;
