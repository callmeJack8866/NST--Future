export default () => ({
    ...
    blockchain: {
      ...
      usdtAddress: process.env.USDT_ADDRESS || '0xaB8729c64385E202750c1A08Ac25cA3410E5201d',
      usdcAddress: process.env.USDC_ADDRESS || '0x1e7FC218ef637705Ec3aFfEDee9C6CfE31368CBf',
    },
    frontend: {
